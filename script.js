...
const recommendations = {
  ...
  olymp: 'Лучший маршрут: наставник одарённых → олимпиады, НПК, ОВСУ, конкурсы и задания повышенной сложности.',
...
const diagnosticMentors = {
  ...
  olymp: { icon: '🌟', title: 'Наставник одарённых', short: 'Ваш наставник для сильных учеников, олимпиад, НПК и конкурсов.', text: 'Поможет провести диагностику, составить план подготовки, подобрать задания, разобрать ошибки и усилить защиту.', links: [['Новое окошко наставника', 'pages/nastavnik-odarennyh.html'], ['Олимпиада', 'pages/nuzhno-podgotovit-uchenika-k-olimpiade.html']] },
...
function activateBoardLinks() {
  ...
  const links = [
    ...
    ['teachers','Наставник одарённых','pages/nastavnik-odarennyh.html','Наставник одарённых помогает готовить учеников к олимпиадам, НПК, ОВСУ и конкурсам.','Открыть новое окошко «Наставник одарённых»','Олимпиады, НПК, ОВСУ, конкурсы'],
