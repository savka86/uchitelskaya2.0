const CACHE='radar-azs-shell-v10';
const SHELL=['/','/pwa.html','/pwa-bootstrap.js','/pwa-photo-v8.js','/index.html','/privacy.html','/rights.html','/manifest.webmanifest','/pwa-icon.svg','/version.json'];
